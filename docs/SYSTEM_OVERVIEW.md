...
- **packages/climate/**
  ...
  - [packages/climate/husvagn.yaml](packages/climate/husvagn.yaml)
...
- **packages/frigate/**
  ...
  - [packages/frigate/frigate_media.yaml](packages/frigate/frigate_media.yaml)
  - [packages/frigate/frigate_person_detected.yaml](packages/frigate/frigate_person_detected.yaml)
  - [packages/frigate/frigate_sensors.yaml](packages/frigate/frigate_sensors.yaml)
  - [packages/frigate/frigate_temp_presence.yaml](packages/frigate/frigate_temp_presence.yaml)
- **packages/helpers/**
  - [packages/helpers/input_booleans.yaml](packages/helpers/input_booleans.yaml)
  - [packages/helpers/input_datetimes.yaml](packages/helpers/input_datetimes.yaml)
...
- **packages/integrations/**
  ...
  - [packages/integrations/rest_command.yaml](packages/integrations/rest_command.yaml)
  ...
  - [packages/integrations/volvo.yaml](packages/integrations/volvo.yaml)
  - [packages/integrations/zwift.yaml](packages/integrations/zwift.yaml)
- **packages/lights/**
  ...
  - [packages/lights/helpers/bathroom.yaml](packages/lights/helpers/bathroom.yaml)
  - [packages/lights/helpers/facade.yaml](packages/lights/helpers/facade.yaml)
  - [packages/lights/helpers/garden.yaml](packages/lights/helpers/garden.yaml)
  - [packages/lights/helpers/hall.yaml](packages/lights/helpers/hall.yaml)
  - [packages/lights/helpers/inside.yaml](packages/lights/helpers/inside.yaml)
  - [packages/lights/helpers/kitchen.yaml](packages/lights/helpers/kitchen.yaml)
  - [packages/lights/helpers/outdoor_room.yaml](packages/lights/helpers/outdoor_room.yaml)
  - [packages/lights/helpers/spabad.yaml](packages/lights/helpers/spabad.yaml)
...
- **packages/media/**
  - [packages/media/google.yaml](packages/media/google.yaml)
  - [packages/media/harmony_hub.yaml](packages/media/harmony_hub.yaml)
...
- **packages/scripts/**
  ...
  - [packages/scripts/lights/bathroom.yaml](packages/scripts/lights/bathroom.yaml)
  - [packages/scripts/lights/facade.yaml](packages/scripts/lights/facade.yaml)
  - [packages/scripts/lights/garden.yaml](packages/scripts/lights/garden.yaml)
  - [packages/scripts/lights/hall.yaml](packages/scripts/lights/hall.yaml)
  - [packages/scripts/lights/inside.yaml](packages/scripts/lights/inside.yaml)
  - [packages/scripts/lights/kitchen.yaml](packages/scripts/lights/kitchen.yaml)
  - [packages/scripts/lights/outdoor_room.yaml](packages/scripts/lights/outdoor_room.yaml)
  - [packages/scripts/lights/spabad.yaml](packages/scripts/lights/spabad.yaml)
- **packages/sensors/**
  - [packages/sensors/command_line_sensors.yaml](packages/sensors/command_line_sensors.yaml)
  - [packages/sensors/ljusstyrka_thresholds.yaml](packages/sensors/ljusstyrka_thresholds.yaml)
  - [packages/sensors/template_sensors/template_aqara_fp2_kitchen.yaml](packages/sensors/template_sensors/template_aqara_fp2_kitchen.yaml)
  - [packages/sensors/template_sensors/template_harmony_hub.yaml](packages/sensors/template_sensors/template_harmony_hub.yaml)
  - [packages/sensors/template_sensors/template_ljusstyrka.yaml](packages/sensors/template_sensors/template_ljusstyrka.yaml)
  - [packages/sensors/template_sensors/template_lumi_ht_agl02_hall_is_not_working.yaml](packages/sensors/template_sensors/template_lumi_ht_agl02_hall_is_not_working.yaml)
  - [packages/sensors/template_sensors/template_lumi_ht_agl02_livingroom.yaml](packages/sensors/template_sensors/template_lumi_ht_agl02_livingroom.yaml)
  - [packages/sensors/template_sensors/template_lumi_weather_bathroom.yaml](packages/sensors/template_sensors/template_lumi_weather_bathroom.yaml)
  - [packages/sensors/template_sensors/template_sensor_reading_missing.yaml](packages/sensors/template_sensors/template_sensor_reading_missing.yaml)
  - [packages/sensors/template_sensors/template_system_info.yaml](packages/sensors/template_sensors/template_system_info.yaml)
  - [packages/sensors/template_sensors/template_timmerflotte_temp_hmd_1_uterum.yaml](packages/sensors/template_sensors/template_timmerflotte_temp_hmd_1_uterum.yaml)
  - [packages/sensors/template_sensors/template_timmerflotte_temp_hmd_2_hall.yaml](packages/sensors/template_sensors/template_timmerflotte_temp_hmd_2_hall.yaml)
  - [packages/sensors/template_sensors/template_timmerflotte_temp_hmd_4_friggebod.yaml](packages/sensors/template_sensors/template_timmerflotte_temp_hmd_4_friggebod.yaml)
  - [packages/sensors/template_sensors/template_timmerflotte_temp_hmd_forrad.yaml](packages/sensors/template_sensors/template_timmerflotte_temp_hmd_forrad.yaml)
  - [packages/sensors/template_sensors/template_ventilation_system.yaml](packages/sensors/template_sensors/template_ventilation_system.yaml)
  - [packages/sensors/template_sensors/template_xiaomi_lumi_mgl01_hall.yaml](packages/sensors/template_sensors/template_xiaomi_lumi_mgl01_hall.yaml)
...
- **packages/wiim/**
  - [packages/wiim/wiim.yaml](packages/wiim/wiim.yaml)
